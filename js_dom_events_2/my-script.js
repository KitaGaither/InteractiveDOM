...
// ***** I changed inspirationalQuotes to quotes
let quotes = [
...
// ***** Displays random quotes in <p></p>
newP.innerText = randQuote;

// append p element to div#quotes_container.
quotes_container.append(newP);
